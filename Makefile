...
SRCS = kvstore.c src/core/protocol.c src/network/ntyco.c src/network/proactor.c src/engines/kvs_array.c src/engines/kvs_rbtree.c src/engines/kvs_hash.c src/engines/kvs_skiplist.c src/persistence/ksf.c src/persistence/aof.c src/utils/memory_pool.c
